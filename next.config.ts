...
const nextConfig: NextConfig = {
  async redirects() {
    return [
      ...
      { source: "/portfolio", destination: "/portafolio", permanent: true },
      { source: "/portfolio-details", destination: "/portafolio", permanent: true },
      { source: "/blog", destination: "/", permanent: true },
      { source: "/blog-details", destination: "/", permanent: true },
      { source: "/portafolio/detalle", destination: "/portafolio", permanent: true },
