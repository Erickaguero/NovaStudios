        ...
        <div className="container">
          <div className="row g-4 g-lg-5 align-items-center">
            <div className="col-12 col-lg-6">
              <h2 className="mb-4" style={{ color: '#FEFEFE' }}>{content.titulo}</h2>
              ...
              <div>
                ...
                <div style={{ ...infoStyle, marginBottom: 0 }}>
                  ...
                  <span><span style={{ color: '#ECC80B', fontWeight: 600 }}>Cobertura:</span> {content.cobertura}</span>
                </div>
              </div>
            </div>
            ...
            <div className="col-12 col-lg-6">
              <div className="contact-form" style={{ margin: 0 }}>
                <h3 className="mb-4">{content.form_titulo}</h3>
